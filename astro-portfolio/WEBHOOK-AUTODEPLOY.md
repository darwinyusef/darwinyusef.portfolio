...
# Levantar todo (Portfolio + Nginx + Webhook + Jenkins + Minio)
...
### 2. Jenkins (Puerto 8080) - Opcional

**Pipeline más avanzado con UI.**

```bash
# Primera vez - obtener password inicial
docker exec portfolio-jenkins cat /var/jenkins_home/secrets/initialAdminPassword

# Acceder
http://YOUR_SERVER_IP:8080/jenkins

# Logs
docker logs -f portfolio-jenkins
```

**Configurar Jenkins:**

1. Acceder a http://YOUR_SERVER_IP:8080/jenkins
...
6. Configure:
   ...
   - SCM: Git
   - Repository: https://github.com/darwinyusef/darwinyusef.portfolio.git
   - Branch: */main
   - Script Path: astro-portfolio/Jenkinsfile.docker
